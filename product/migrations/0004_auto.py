...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field cover_image on 'Product'
        m2m_table_name = db.shorten_name(u'product_product_cover_image')
    ...
    def backwards(self, orm):
        # Removing M2M table for field cover_image on 'Product'
        db.delete_table(db.shorten_name(u'product_product_cover_image'))
    ...
    models = {
        ...
        u'product.product': {
            ...
            'cover_image': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'product-cover-image+'", 'symmetrical': 'False', 'to': u"orm['media_library.Image']"}),
